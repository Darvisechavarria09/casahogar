				...
				<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  					<div class="carousel-inner">
  						<div class="carousel-item active">
  						    <img src="<?= base_url('public/img/imagen1.jpg') ?>" class="img-fluid d-block w-100" alt="...">
  						</div>
  						<div class="carousel-item">
  						    <img src="<?= base_url('public/img/imagen2.jpg') ?>" class="img-fluid d-block w-100" alt="...">
  						</div>
  						<div class="carousel-item">
  						    <img src="<?= base_url('public/img/imagen3.jpg') ?>" class="img-fluid d-block w-100" alt="...">
  						</div>
  					</div>
		...
		<div class="container mb-5">
			<div class="row mt-5">
				...
				<div class="col-12 col-md-6 align-self-center">
					...
					<h2 class="fuente2 fw-bold">Hogar Animal Planet</h2>
					<p class="fuente2">
